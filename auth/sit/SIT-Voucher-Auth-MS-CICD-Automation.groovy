pipeline {
    ...
    stages {
        stage('Run unit tests') {
            steps {
                checkout scmGit(branches: [[name: '*/development']], extensions: [], userRemoteConfigs: [[credentialsId: '4cd38c69-0258-4572-807e-10c86f7d5824', url: 'git@github.com:ralphlui/voucher-app-auth-3.0.git']])
                sh 'mvn -B clean test'
            }
        }
